...
async def set_commands(client):
    if config_dict['SET_COMMANDS']:
        await client.set_bot_commands([
            ...
            BotCommand(f'{BotCommands.PingCommand[0]}', f'Check how long it takes to Ping the Bot.'),
            BotCommand(f'{BotCommands.ShellCommand}', 'Run shell commands (Only Owner).'),
            ...
            BotCommand(f'{BotCommands.RestartCommand[0]}', 'Restart and update the bot'),
            BotCommand(f'{BotCommands.LogCommand}', 'Get a log file of the bot.'),
